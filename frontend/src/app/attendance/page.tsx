  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans transition-ui duration-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-7">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex items-center flex-wrap gap-2.5">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-700 hover:bg-emerald-800 text-white text-xs sm:text-sm font-semibold shadow-sm transition-ui cursor-pointer disabled:opacity-50"
              >
                {isBatchLoading ? (
          ...
          <dl className="grid grid-cols-2 lg:grid-cols-4 gap-px overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-200 dark:bg-slate-800 shadow-xs">
            ...
            <div className="bg-white dark:bg-slate-900 p-4 sm:p-5">
              ...
              <dd className="mt-1 text-xl sm:text-2xl font-extrabold tabular-nums text-emerald-700 dark:text-emerald-400">
                {attendanceRate}%
              </dd>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-4 sm:p-5">
              ...
              <dd className="mt-1 text-xl sm:text-2xl font-extrabold tabular-nums text-rose-700 dark:text-rose-400">
      ...
      {isDetailModalOpen && selectedStudentForDetail && (
        <div role="dialog" aria-modal="true" aria-labelledby="attendance-detail-title" className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in duration-150">
      ...
      {isStatsModalOpen && (
        <div role="dialog" aria-modal="true" aria-labelledby="attendance-stats-title" className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in duration-150">
