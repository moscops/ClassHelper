  ...
  return (
    <AppLayout currentPath="/staff">
      <div className="space-y-6 pb-12">
        ...
        {/* 1. Header Banner */}
        <div className="relative overflow-hidden rounded-3xl bg-linear-to-r from-indigo-900 via-indigo-800 to-purple-900 text-white p-6 sm:p-8 shadow-xl">
          <div className="absolute top-0 right-0 -mt-8 -mr-8 w-64 h-64 bg-indigo-500/20 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute bottom-0 right-32 -mb-8 w-48 h-48 bg-purple-500/20 rounded-full blur-2xl pointer-events-none" />

          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="space-y-2">
              <div className="flex items-center gap-2.5">
                <span className="px-3 py-1 rounded-full bg-white/15 backdrop-blur-md text-[11px] font-bold text-indigo-200 border border-white/10 flex items-center gap-1.5">
              ...
              <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight flex items-center gap-3">
                <span>학원 교직원 & 강사 관리</span>
                <span className="text-sm font-semibold px-2.5 py-0.5 rounded-xl bg-white/15 text-indigo-100">
                  총 {stats.totalStaff}명
                </span>
              </h1>
              <p className="text-xs sm:text-sm text-indigo-100/90 max-w-2xl leading-relaxed">
                {academy?.name || '학원'}에 소속된 부원장, 전임/파트 강사, 조교 계정을 체계적으로 등록하고 담당 수업 반 배정 및 시스템 권한을 안전하게 관리합니다.
              </p>
            </div>
            ...
            <div className="flex items-center gap-2.5 shrink-0 flex-wrap">
              <button
                ...
                disabled={isLoading}
                className="px-3.5 py-2.5 rounded-2xl bg-white/10 hover:bg-white/20 text-white text-xs font-semibold backdrop-blur-md border border-white/15 flex items-center gap-1.5 transition-all cursor-pointer shadow-xs disabled:opacity-50"
              >
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-2xl bg-white hover:bg-indigo-50 text-indigo-900 text-xs sm:text-sm font-bold flex items-center gap-2 transition-all cursor-pointer shadow-lg shadow-indigo-950/30 hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]"
              >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              ...
              <div className="w-9 h-9 rounded-2xl bg-indigo-50 dark:bg-indigo-950/70 flex items-center justify-center text-indigo-600 dark:text-indigo-400">
          ...
          <div className="p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              ...
              <div className="w-9 h-9 rounded-2xl bg-emerald-50 dark:bg-emerald-950/70 flex items-center justify-center text-emerald-600 dark:text-emerald-400">
          ...
          <div className="p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              ...
              <div className="w-9 h-9 rounded-2xl bg-purple-50 dark:bg-purple-950/70 flex items-center justify-center text-purple-600 dark:text-purple-400">
          ...
          <div className="p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              ...
              <div className="w-9 h-9 rounded-2xl bg-amber-50 dark:bg-amber-950/70 flex items-center justify-center text-amber-600 dark:text-amber-400">
