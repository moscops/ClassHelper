                  ...
                  {selectedDateClasses.length === 0 ? (
                    ...
                    <div className="space-y-2 max-h-48 overflow-y-auto pr-1">
                      {selectedDateClasses.map((cls) => (
                        <div
                          key={cls.id}
                          className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/70 dark:border-slate-700/60 text-xs flex items-center justify-between"
                        >
                          <div>
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      {dayClasses.map((cls) => (
                        <div
                          key={cls.id}
                          className="p-2.5 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-2xs text-xs space-y-1"
                        >
                          ...
                          <div className="text-[10px] text-slate-400 flex items-center justify-between">
                            ...
                            <span className="font-semibold">{cls.enrolledCount}명</span>
                          </div>
                        </div>
                      ))}
                    </div>
                    ...
                    {(['INDIGO', 'PURPLE', 'ROSE', 'AMBER', 'EMERALD', 'BLUE'] as EventColor[]).map(
                      (c) => (
                        <button
                          ...
                          className={`w-6 h-6 rounded-full ${COLOR_CLASSES[c].dot} transition-transform ${
