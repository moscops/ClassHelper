      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <button
                        ...
                        className="text-slate-500 dark:text-slate-400 hover:text-rose-500 cursor-pointer p-0.5"
                        title="공지 삭제"
                      >
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="p-1.5 rounded-lg text-slate-500 dark:text-slate-400 hover:text-rose-600 dark:hover:text-rose-300 cursor-pointer"
                  title="알림 지우기"
                >
        ...
        <div className="space-y-3">
          {isLoading ? (
            ...
            <div className="p-12 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 text-center text-slate-500 dark:text-slate-400 space-y-2">
              ...
              >
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {item.channel === 'KAKAO' && (
                        <span className="px-2 py-0.5 rounded-md text-[10px] font-semibold bg-amber-50 dark:bg-amber-950/60 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-800 flex items-center gap-1">
                          <MessageSquare className="w-3 h-3 text-amber-700 dark:text-amber-400" />
                          <span>카카오 알림톡</span>
                        </span>
                      )}
                ...
                <div className="flex items-center gap-2 self-end sm:self-center shrink-0">
                  ...
                  <button
                    ...
                    disabled={actionLoadingId === item.id}
                    className="p-1.5 rounded-xl bg-slate-100 hover:bg-rose-50 dark:bg-slate-800 dark:hover:bg-rose-950/50 text-slate-600 dark:text-slate-400 hover:text-rose-600 dark:hover:text-rose-400 border border-slate-200 dark:border-slate-700 transition-colors cursor-pointer"
                    title="알림 삭제"
                  >
                    <Trash2 className="w-3.5 h-3.5" />
                  </button>
