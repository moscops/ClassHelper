...
export default function ChangePasswordPage() {
  ...
  return (
    <div className="min-h-screen relative flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors">
      ...
      <div className="absolute top-4 right-4 sm:top-6 sm:right-6 flex items-center gap-2.5 z-20">
        ...
        {isMustChange ? (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white dark:bg-slate-900 hover:bg-rose-50 dark:hover:bg-rose-950/40 border border-slate-200 dark:border-slate-800 text-xs font-semibold text-slate-600 dark:text-slate-300 hover:text-rose-600 transition-all shadow-2xs cursor-pointer"
          >
          ...
          <button
            type="button"
            onClick={() => router.back()}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-800 text-xs font-semibold text-slate-600 dark:text-slate-300 transition-all shadow-2xs cursor-pointer"
          >
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="mt-4 text-2xl font-bold tracking-tight text-slate-900 dark:text-white flex items-center justify-center gap-2">
            <KeyRound className="w-6 h-6 text-indigo-600 dark:text-indigo-400" />
            <span>비밀번호 변경</span>
          </h2>
          <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
            {isMustChange
              ? '임시 비밀번호로 로그인하셨습니다. 안전한 사용을 위해 새 비밀번호를 등록해주세요.'
              : '주기적인 비밀번호 변경으로 계정 보안을 안전하게 유지하세요.'}
          </p>
        </div>
